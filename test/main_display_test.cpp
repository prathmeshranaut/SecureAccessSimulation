...
int main(){
    ...
    const char * i_input_data_control = "../input_data/display_input_test.txt";
    ...
    shared_ptr<dynamic::modeling::model> display = dynamic::translate::make_dynamic_atomic_model<Display, TIME>("display");

    /*******TOP MODEL********/
    dynamic::modeling::Ports iports_TOP = {};
    dynamic::modeling::Ports oports_TOP = {typeid(outp)};
    dynamic::modeling::Models submodels_TOP = {input_reader, display};
    dynamic::modeling::EICs eics_TOP = {};
    dynamic::modeling::EOCs eocs_TOP = {
            dynamic::translate::make_EOC<Display_defs::out,outp>("display")
    };
    dynamic::modeling::ICs ics_TOP = {
            dynamic::translate::make_IC<iestream_input_defs<Message_t>::out,Display_defs::in>("input_reader","display")
    };
    ...
    /*************** Loggers *******************/
    static ofstream out_messages("../simulation_results/display_test_output_messages.txt");
    struct oss_sink_messages{
        static ostream& sink(){
            return out_messages;
        }
    };
    static ofstream out_state("../simulation_results/display_test_output_state.txt");
